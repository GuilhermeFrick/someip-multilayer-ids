...
## Refinamentos opcionais (para fechar o gap)
- [ ] Treinar mais épocas (100–150) e/ou early stopping pela loss.
- [ ] Otimização Bayesiana dos hiperparâmetros (`optuna`) no nosso pipeline.
- [ ] Baseline single-GRU para comparação direta (esperado: replay bem pior, como no artigo).
